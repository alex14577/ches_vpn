...
SELECT format('CREATE ROLE %I LOGIN PASSWORD %L INHERIT', :'vpn_worker_username', :'vpn_worker_password')
WHERE NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = :'vpn_worker_username')
\gexec
SELECT format('ALTER ROLE %I INHERIT PASSWORD %L', :'vpn_worker_username', :'vpn_worker_password')
...
GRANT USAGE ON SCHEMA public TO :"vpn_bot_username", :"vpn_worker_username", :"vpn_subscription_username";
GRANT SELECT, INSERT, UPDATE ON ALL TABLES IN SCHEMA public TO :"vpn_bot_username", :"vpn_worker_username", :"vpn_subscription_username";
GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA public TO :"vpn_bot_username", :"vpn_worker_username", :"vpn_subscription_username";
